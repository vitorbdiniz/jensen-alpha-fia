...
from scripts.util.util import rearange_prices
from scripts.util import padding as pad

from scripts.carteiras.carteira_tamanho import get_market_caps
from scripts.carteiras.carteira_valor import get_all_book_to_market
from scripts.carteiras.carteira_liquidez import get_liquidities
from scripts.carteiras.carteira_momentum import get_momentum
from scripts.carteiras.carteira_BAB import get_all_betas
from scripts.carteiras.fator_qualidade import carteiraQuality 
